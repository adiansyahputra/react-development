...
const dispatchEmailReducer = (state, action) => {
...
const dispatchPasswordReducer = (state, action) => {
  if (action.type === 'USER_INPUT') {
...
const Login = (props) => {
  ...
  const [emailState, dispatchEmail] = useReducer(dispatchEmailReducer, { value: '', isValid: null });

  const [passwordState, dispatchPassword] = useReducer(dispatchPasswordReducer, { value: '', isValid: null });
